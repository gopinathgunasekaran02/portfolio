      ...
      <div class="max-w=[800px] mx-auto">
        ...
        <div class="mt-6 bg-[#161616] rounded-xl">
            <div class="p-10">
                ...
                <form action='https://getform.io/f/ayvkppkb' method='POST'>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">

                    <div>
                        <div class="mt-2.5">
                            <input type="name" name="name" id="" placeholder="Your Name"
                                class="bg-[#161616] w-full px-4 py-4 text-gray-400 placeholder-gray-400 border border-gray-700 rounded-md focus:outline-none focus:border-green-300" />
                        </div>
                        </div>  
